...
export default function DashboardClient({ transactions, savingsGoal, userEmail }: Props) {
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-indigo-600 px-5 pt-12 pb-8 text-white">
        <div className="flex justify-between items-start mb-6">
          <div>
            <p className="text-indigo-200 text-sm">Good {greeting()}</p>
            <p className="font-semibold truncate max-w-[200px]">{userEmail}</p>
          </div>
          <button
